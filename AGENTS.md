...
A Windows system-tray utility (Tauri v2 + React 19 + TypeScript frontend, Rust backend) that polls usage/quota data from locally installed AI coding tools—Codex, Codex CLI, Cursor, Amp, and Factory Droid—and displays it in a small popup anchored to the system tray.
